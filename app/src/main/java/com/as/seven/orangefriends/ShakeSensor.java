 ...
 * @Description: 摇一摇传感器，内部原理为加速度传感器，摇一摇到达速度阀值则发出相应的动作， 回调onShakeComplete方法
 * @author Mr.Simple
...
public class ShakeSensor implements SensorEventListener {
    ...
    private int mSpeedStarthold = DEFAULT_SHAKE_START_SPEED;
    /**
     * 传感器检测变化的时间间隔
     */
    ...
    public static final int DEFAULT_SHAKE_START_SPEED = 2000;
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        // 开始摇动事件
//        if (mSpeedStarthold < speed && speed < mSpeedShreshold && mShakeListener != null) {
//            mShakeListener.onShakeStart(event);
//        }
